/*
 ...
 /**
    ...
    * @n           - MWB_SCANDIRECTION_AUTODETECT - enables ManateeBarcodeScanner's
 ...
 * Set maximum threads to be used for decoding. Value will be limited to maximum available CPU cores.
 ...
 MWBsetCustomParam: function(key, value) {
    ...
    */
    ...
    MWBshowToast: function(msg) {

      cordova.exec(function(){}, function(){}, "MWBarcodeScanner", "showToast", [msg]);
 ...
 manateeScanner = {};
 manateeScanner.resume = function() {

    setTimeout(function(){                  //
       ManateeBarcodeScanner.MWBresumeScanning();  // Use this sample when using mwbs['MWBcloseScannerOnDecode'](false);
    },1000);

 };

 manateeScanner.toast = function(msg) {

   ManateeBarcodeScanner.MWBshowToast(msg);  // Use this sample when using mwbs['MWBcloseScannerOnDecode'](false);


 };

 manateeScanner.startScanning = function(initMWBS,callbackMWBS, continuous) {


    //Initialize decoder with default params
    ManateeBarcodeScanner.MWBinitDecoder(function(){
        ...
        var initFunc = (typeof initMWBS === 'function')?initMWBS:function(mwbs,constants,dvc){
            ...
            //    try{
                    var mwregister = {
                       'Android' : {
                           ...
                           'MWB_CODE_MASK_128' : {'username':'werner.venter@britehouse.co.za','key':'05E19CC44BFCBCC6A1F49C1CEA5792B7DECABB9F582EE8B04A1E45FCD11F97A6'},
            ...
            //    try{
                  ...
                  //  mwbs['MWBsetMaxThreads'](1);
                    mwbs['MWBcloseScannerOnDecode'](!continuous);
        ...
        initFunc(ManateeBarcodeScanner,CONSTANTS,device);
        ...
        ManateeBarcodeScanner.MWBstartScanning(callFunc);
    });
 }
    module.exports = manateeScanner;
